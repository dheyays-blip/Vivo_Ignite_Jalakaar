...
(function () {
  ...
  /* ------------------------------------------------------------------ */
  /* Sign-in and sending USED TO LIVE HERE, and no longer do.            */
  /*                                                                     */
  /* This page showed a different thing to every role: a sign-in form to  */
  /* visitors, a broadcast button to officials, nothing usable to a       */
  /* farmer. A demo whose shape depends on who is watching is a demo you  */
  /* cannot rehearse. It is now identical for everyone — pick a place,    */
  /* read the score, read the message in three languages — and sending,   */
  /* which is an official action, lives in the control room where the     */
  /* permission check has one implementation instead of two.              */
  /* ------------------------------------------------------------------ */
